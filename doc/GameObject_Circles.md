...
Once created, the circle can be added to the scene using `level_add_ellipse()`. All standard ellipse methods documented in `GameObject_Ellipses.md` can be used on the returned object.
