...
Once created, the square can be added to the scene using `level_add_rectangle()`. All standard rectangle methods documented in `GameObject_Rectangles.md` can be used on the returned object.
