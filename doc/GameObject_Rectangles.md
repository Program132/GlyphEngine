...
| rectangle_new_textured   | struct GameObject_Rectangle*  | int x, int y, int width, int height, struct Texture *texture                                  | Dynamically allocates and initializes a new textured rectangle.                             |
